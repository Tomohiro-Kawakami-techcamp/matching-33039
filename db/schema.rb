...
ActiveRecord::Schema.define(version: 2021_01_19_062853) do
  ...
  create_table "messages", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["thank_id"], name: "index_messages_on_thank_id"
  end
  ...
  create_table "thanks", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.integer "vote_profile_id"
    t.index ["profile_id"], name: "index_thanks_on_profile_id"
  end
  ...
  add_foreign_key "messages", "thanks"
  add_foreign_key "profiles", "users"
  add_foreign_key "thanks", "profiles"
